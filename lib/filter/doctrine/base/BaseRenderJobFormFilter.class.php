...
abstract class BaseRenderJobFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'status'              => new sfValidatorChoice(array('required' => false, 'choices' => array('new' => 'new', 'queued' => 'queued', 'processing' => 'processing', 'processed' => 'processed', 'failed' => 'failed', 'waiting' => 'waiting'))),
